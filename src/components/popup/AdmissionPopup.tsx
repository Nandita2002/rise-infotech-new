  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-xs animate-fade-in">
        {/* up Card */}
        <div className="relative w-[92vw] max-w-[420px] overflow-hidden  bg-white shadow-2xl">
          ...
          {/* Header */}
          <div className="bg-gradient-to-r from-[#0769B4] to-[#055A99] px-5 py-4 text-center">

            <span className="inline-block rounded-full bg-white/20 px-3 py-1 text-[11px] font-semibold uppercase tracking-wide text-blue-100">
              Admissions Open • August 2026 Batch
            </span>

            <h2 className="mt-3 text-lg font-bold leading-tight text-white sm:text-2xl">
              Get 25% OFF on All SAP Courses
            </h2>

            <p className="mt-2 text-sm text-blue-100">
              Limited Time Offer • Enroll Today & Start Your SAP Career
            </p>
          ...
          <div className="p-5">
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <input
                  ...
                  className="rounded-xl border border-slate-200 px-4 py-2.5
                   text-slate-800 placeholder-slate-400 focus:border-[#0769B4] focus:ring-2 focus:ring-[#0769B4]/20 outline-none transition-all"
                />
              </div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-slate-800 placeholder-slate-400 focus:border-[#0769B4] focus:ring-2 focus:ring-[#0769B4]/20 outline-none transition-all"
              />
              ...
              <select
                ...
                onChange={handleChange}
                required
                className="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-slate-800 bg-white focus:border-[#0769B4] focus:ring-2 focus:ring-[#0769B4]/20 outline-none transition-all"
              >
              ...
              <textarea
                ...
                className="w-full rounded-xl border border-slate-200 px-4 py-2.5 text-slate-800 placeholder-slate-400 focus:border-[#0769B4] focus:ring-2 focus:ring-[#0769B4]/20 outline-none transition-all resize-none"
              />

              <button
                type="submit"
                disabled={loading}
                className="w-full rounded-xl bg-[#0769B4] py-2.5 font-bold text-white shadow-md hover:bg-[#055A99] hover:shadow-lg transition-all active:scale-[0.99] disabled:opacity-70 disabled:cursor-not-allowed cursor-pointer flex justify-center items-center gap-2"
              >
                {loading ? (
                  <>
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/50 p-4 backdrop-blur-xs">
          <div className="w-full max-w-md rounded-3xl bg-white p-8 text-center shadow-2xl transform transition-all">
            ...
            <button
              ...
              className="mt-6 w-full rounded-xl bg-[#0769B4] py-2.5 font-semibold text-white hover:bg-[#055A99] shadow-md transition-colors cursor-pointer"
            >
              Continue
            </button>
          </div>
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/50 p-4 backdrop-blur-xs">
          <div className="w-full max-w-md rounded-3xl bg-white p-8 text-center shadow-2xl">
            ...
            <button
              ...
              className="mt-6 w-full rounded-xl bg-red-600 py-2.5 font-semibold text-white hover:bg-red-700 transition-colors cursor-pointer"
            >
              Try Again
            </button>
          </div>
