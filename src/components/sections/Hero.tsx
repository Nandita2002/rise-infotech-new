...
export default function Hero({ onOpenPopup }: HeroProps) {
  ...
  text-xl sm:text-xl md:text-xl lg:text-2xl xl:text-3xl
  text-slate-900"
            >
              Bengaluru's Best Software Training Institute
              <br />
              <span className="text-[#0769B4]">
            ...
            >
              At Rise Infotech, we don't just train—we build the skills, confidence and career readiness you need to succeed in today's technology-driven world.
            </motion.p>
            ...
            >
              <Link
                href="/#courses"
                className="flex-1 sm:flex-none inline-flex items-center justify-center gap-1.5 sm:gap-2 rounded-lg bg-[#0769B4]
  px-3 py-2.5 text-[13px] sm:px-5 sm:py-3 sm:text-sm
  font-semibold text-white shadow-md transition-all duration-300
  hover:-translate-y-0.5 hover:bg-[#055A99]
  hover:shadow-xl hover:shadow-[#0769B4]/30 active:scale-[0.98]"
              >
                <BookOpen size={14} className="sm:w-[15px] sm:h-[15px]" />
                Explore Courses
              ...
              <button
                onClick={onOpenPopup}
                className="group flex-1 sm:flex-none inline-flex items-center justify-center gap-1.5 sm:gap-2 rounded-lg border-2 border-[#0769B4]
  bg-white px-3 py-2.5 text-[13px] sm:px-5 sm:py-3 sm:text-sm
  font-semibold text-[#0769B4] transition-all duration-300
  hover:-translate-y-0.5 hover:border-[#0769B4]
  hover:bg-[#0769B4] hover:text-white
  hover:shadow-xl hover:shadow-[#0769B4]/30 active:scale-[0.98]"
              >
                <Calendar
                  size={13}
                  className="transition-colors duration-300 group-hover:text-white sm:w-[14px] sm:h-[14px]"
                />
                Book a Consultation
              </button>
            </motion.div>
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="hidden lg:flex flex-1 relative items-center justify-center w-full min-h-[540px]"
          >
