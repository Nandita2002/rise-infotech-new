  ...
  return (
    <section className="bg-white py-16 overflow-hidden">
      <div className="mb-16 overflow-hidden bg-[#0769B4] px-8 py-10 text-center shadow-xl">
        ...
        <div className="mt-3 inline-flex items-center gap-3 rounded-full border border-white/20 bg-white/10 px-6 py-3 backdrop-blur-sm">
        ...
        >
          {allTestimonials.map((item, i) => {
            ...
            return (
              <div
                key={i}
                className={`t-card flex-shrink-0 transition-all duration-300 ${isActive ? "sm:scale-[1.03] opacity-100" : "sm:scale-[0.94] opacity-75"
                  }`}
              >
                <div
                  className={`bg-white rounded-2xl p-5 sm:p-6 flex flex-col gap-4 w-[85vw] max-w-[320px] sm:w-[300px] md:w-[320px] min-h-[240px] transition-all duration-300 ${isActive
