...
export default function SapCoursesPage() {
  // Show only SAP courses
  const sapCourses = courses.filter((course) =>
    course.slug.startsWith("sap-")
  )
      ...
      <Container>
        ...
        <div className="mb-14 bg-[#0769B4] px-8 py-12 text-center text-white">
          ...
          <p className="mx-auto mt-5 max-w-3xl text-lg leading-8 text-blue-100">
            ...
            live instructor-led classes, hands-on projects, certification
        ...
        <div className="mx-auto mt-16 flex max-w-3xl items-center justify-center gap-3 border border-slate-200 bg-slate-50 px-6 py-5 text-center">
          ...
          <p className="text-sm text-slate-600">
            Secure admissions • Industry-certified trainers • Placement
            assistance • Live instructor-led training
          </p>
        </div>
      </Container>
    </section>
